...
(() => {
  ...
  const L = {
    ...
    qr:           {x: 74, y: 1183, size: 130},
    verCode:      {x: 365, y: 1193, w: 425, h: 34},
    verStatus:    {x: 365, y: 1253, w: 425, h: 34},
    verUrl:       {x: 365, y: 1313, w: 630, h: 34}
  };
  ...
  async function draw() {
    ...
    try {
      ...
      // Cover the template placeholder text while preserving the printed QR frame.
      ctx.save();
      ctx.fillStyle = "#FFFFFF";
      ctx.fillRect(74, 1182, 132, 132);
      ctx.restore();
