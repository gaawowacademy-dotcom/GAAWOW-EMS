/* GAAWOW EMS Authentication Letter Generator v18 */
(() => {
  "use strict";
  ...
  async function drawQR(x,y,size){
    ...
    try{
      if(window.QRious){
        ...
        new QRious({element:off, value:url, size:size*2, level:"M"});
      ...
      throw new Error("QR library (window.QRious) lama helin — hubi in qrious script-ku uu ka horreeyo authentication-letter.js.");
    }catch(e){
